...
const ProductCard: React.FC<ProductCardProps> = ({ imageUrl, title, price, oldPrice, discount, rating, numReviews }) => {
  return (
    <a
      href="#"
      className="w-72 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden transition-transform transform hover:scale-105 no-underline"
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mt-2">
          ...
          <span className="ml-2 text-xs text-gray-500">({numReviews} оценок)</span>
        </div>
        <div className="flex items-center mt-2">
